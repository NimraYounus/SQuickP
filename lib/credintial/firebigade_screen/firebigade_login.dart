...
class FireBigadeLogin extends StatefulWidget {
  const FireBigadeLogin({Key? key}) : super(key: key);
  @override
  State<FireBigadeLogin> createState() => _FireBigadeLoginState();
}

class _FireBigadeLoginState extends State<FireBigadeLogin> {
  ...
  Widget build(BuildContext context) {
    final loginButton = ElevatedButton(
      ...
      onPressed: () {
        ...
        Navigator.pushNamed(context, '/firebigadeHome');
      },
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                AnimatedTextKit(
                  animatedTexts: [
                    TyperAnimatedText('Firebigade Login Here!',
